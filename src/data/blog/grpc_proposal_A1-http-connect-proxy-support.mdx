---
title: "gRPC Proposal Series - Behind the Proxy Curtain"
author: eunsang
pubDatetime: 2025-08-16T01:00:00Z
modDatetime: 2025-08-16T01:00:00Z
slug: grpc-proposal-series-behind-the-proxy-curtain
featured: false
draft: false
tags: [grpc, proposal]
description: ""
...
I’ve often felt lost when it comes to the networking layers — L3, L4, L7 — and gRPC always seemed like a black box to me. To fix that, I’m starting the **"gRPC Proposal Series"**: a collection of posts where I study, dissect, and experiment with gRPC proposals, both to deepen my understanding and to share insights with others navigating the cloud computing world.

gRPC is a high-performance, open-source RPC framework backed by Google, designed with the spirit of efficient, language-agnostic communication. The team behind gRPC documents its core implementation decisions through [proposals on GitHub](https://github.com/grpc/proposal), which serve as the foundation for new features and enhancements.
...
export const notes = {
  ...
  open_issues: `
    <div>
      <h3>Open Issues</h3>
      <p>Nothing critical, but caution is required. Proxy mapper and resolver configurations must stay in sync. If they drift, you’ll run into unexpected behavior or failed connections — so keep them aligned!</p>
    </div>
  `
};
