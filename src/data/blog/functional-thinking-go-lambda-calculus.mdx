...
> “…if $$ ((\lambda x_j N_j) W_j) $$ are parts of 𝐴, then a number 𝑚 can be found such that any sequence of contractions on these parts will terminate after at most 𝑚 contractions… the result is unique up to the order of applying the reduction rules.”
