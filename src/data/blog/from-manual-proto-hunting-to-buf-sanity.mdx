...
The client ([`grpc_client.py`](https://github.com/CynicDog/pokedex-grpc/blob/main/grpc_client.py)) sends a `GetPokemonRequest`, and prints the response from the server. It uses the generated stub class `PokedexServiceStub` to handle the request/response logic.
